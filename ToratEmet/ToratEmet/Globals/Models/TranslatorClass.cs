...
namespace ToratEmet.Models
{
    public static class TransaltorClass
    {
        ...
        {
            if (input.Contains("ToratEmetInstall")) { input = input.TranslateFilename(); }
        ...
        {
            if (input.Contains("ToratEmetInstall")) { input = input.TranslateFolderName(); }
            string output = Path.GetFileName(input);
            output = Regex.Replace(output, @"\d+_?", "").Replace("MyBooks", "הספרים שלי");
            return output;
        }
        public static string TranslateFolderName(this string folderName)
        {
        ...
        public static string TranslateFilename(this string originalFilename)
        {
