...
namespace ToratEmet.Extensions
{
    public static class AppSpecificExtensions
    {
        ...
        public static string FixBookName(this string input)
        {
            input = input.Replace("\'\'", "\"").Trim('\"');
            if (Regex.IsMatch(input, @"\A\S+""\S+"))
            { 
            input = input.Replace("ב\"ק", "בבא קמא")
                     ...
                     .Replace("שמו\"ר", "שמות רבה")
                      .Replace("ויקר\"ר", "ויקרא רבה")
                       .Replace("במ\"ר", "במדבר רבה")
                        ...
                        .Replace("ש\"א", "שמואל א")
                        .Replace("ש\"ב", "שמואל ב")
                        .Replace("דה\"ב", "דברי הימים ב")
                        .Replace("דה\"א", "דברי הימים א");
            }

            return input
                .Replace("דברי הימים ב'", "דברי הימים ב")
                        .Replace("דברי הימים א'", "דברי הימים א")
                        .Replace("שמואל ב'", "שמואל ב")
                        .Replace("שמואל א'", "שמואל א")
                        .Replace("מלכים ב'", "מלכים ב")
                        .Replace("מלכים א'", "מלכים א");
        }
