...
namespace תורת_אמת_בוורד_3._1._3.Models
{
    ...
    {
        private StringCollection recentSearches = תורת_אמת_פלוס_מינוס.Properties.Settings.Default.OpenFileRecentSearches ?? new StringCollection();
        ...
        public void UpdateList(string input)  // Add a new item to the recent items list
        {
            ...
            תורת_אמת_פלוס_מינוס.Properties.Settings.Default.OpenFileRecentSearches = recentSearches;
