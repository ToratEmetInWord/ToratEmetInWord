...
namespace תורת_אמת_בוורד_3._1._3.Models
{
    ...
    {
        public static string ToratEmetCopyRight()
        {
            return @"
<!DOCTYPE html>
                <html lang=""he"">
...
<p style=""background-color:whitesmoke;"">
    תורת אמת בוורד הינו תוסף והרחבה לתוכנה המקורית ונעשה על ידי tosaftorani@gmail.com בכפוף לאותם תנאי רשיון כמו התוכנה המקורית.
</p>
<P><li> <span style=""color:#FF0000;"">אין לעשות בתוכנה זו או בחלק ממנה שימוש מסחרי .</span>
...
<BR><BR><hr><BR>
<li><big><B> תנאי רשיון Creative Commons-CC-2.5: </big></B>
...
<a name='sbl-licence'></a>
<big><b>תנאי הרשיון בגופן SBL</b></big>
...
<div dir='ltr' style='background-color:rgb(255,239,213); padding:20px; border-style:solid; border-width:1px;'>
