...
namespace תורת_אמת_בוורד_3._1._3.Models
{
    ...
    {
        private StringCollection recentBooksHeaders = תורת_אמת_פלוס_מינוס.Properties.Settings.Default.RecentBooks ?? new StringCollection();
        ...
        public void UpdateList(string filePath)  // Add a new item to the recent items list
        {
            ...
            תורת_אמת_פלוס_מינוס.Properties.Settings.Default.RecentBooks = recentBooksHeaders;
