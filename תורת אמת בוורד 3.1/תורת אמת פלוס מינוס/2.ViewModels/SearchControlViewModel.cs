...
namespace תורת_אמת_בוורד_3._1._2.ViewModels
{
    public class SearchControlViewModel : INotifyPropertyChanged
    {
        ...
        bool _searchAllCheckBox = תורת_אמת_פלוס_מינוס.Properties.Settings.Default.SearchALL;
        bool _chooseBooksIsEnabled =! תורת_אמת_פלוס_מינוס.Properties.Settings.Default.SearchALL;
        ...
        public bool SearchAll
        {
            ...
            set
            {
                if (_searchAllCheckBox != value)
                {
                    ...
                    תורת_אמת_פלוס_מינוס.Properties.Settings.Default.SearchALL = value;
