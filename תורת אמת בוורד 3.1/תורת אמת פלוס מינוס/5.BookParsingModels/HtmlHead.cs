    ...
    public static class HtmlHead
    {
        public static string htmlHead(string title)
        {
            return $@"<!DOCTYPE html>
                ...
                text-align: justify;
                direction: rtl;
                font-family:{תורת_אמת_פלוס_מינוס.Properties.Settings.Default.HtmlFontFamily} ;
                font-size: {תורת_אמת_פלוס_מינוס.Properties.Settings.Default.HtmlFontSize}%;
                  height: 100%;
                  margin: 0;
                  padding: 0;
...
";
        ...
        public static string HtmlEnd(string elementId)
        {
            return $@"
<script>
